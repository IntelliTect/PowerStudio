...
namespace Microsoft.VsSDK.IntegrationTestLibrary
{
    ...
    public class TestUtils
    {
        ...
        public static void WriteEmbeddedResourceToBinaryFile( Assembly assembly,
        ...
        /// <returns></returns>
        private static string GetNewFileOrDirectoryNameWithoutCreatingAnything( string directory,
                                                                                string baseFileName,
                                                                                string extension )
        {
        ...
        public void CreateEmptySolution( string directory, string solutionName )
        {
            ...
            Assert.AreEqual( solutionName + ".sln",
                             Path.GetFileName( dte.Solution.FileName ),
        ...
        /// <returns></returns>
        public ProjectItem AddNewItemFromVsTemplate( ProjectItems parent,
                                                     string templateName,
                                                     string language,
                                                     string name )
        {
        ...
        public bool CanFindToolwindow( Guid persistenceGuid )
        {
            ...
            int hr = uiShellService.FindToolWindow( (uint) __VSFINDTOOLWIN.FTW_fFindFirst,
                                                    ref persistenceGuid,
                                                    out windowFrame );
