...
namespace PowerStudio.DebugEngine
{
    ...
    {
        public const int S_ATTACH_DEFERRED = unchecked( 0x40004 );
        public const int S_ATTACH_IGNORED = unchecked( 0x40005 );
        public const int S_JIT_USERCANCELLED = unchecked( 0x400B0 );
        public const int S_JIT_NOT_REG_FOR_ENGINE = unchecked( 0x400B5 );
        public const int S_TERMINATE_PROCESSES_STILL_DETACHING = unchecked( 0x400C0 );
        public const int S_TERMINATE_PROCESSES_STILL_TERMINATING = unchecked( 0x400C1 );
        public const int S_ENC_SETIP_REQUIRES_CONTINUE = unchecked( 0x40106 );
        public const int S_WEBDBG_UNABLE_TO_DIAGNOSE = unchecked( 0x40120 );
        public const int S_WEBDBG_DEBUG_VERB_BLOCKED = unchecked( 0x40121 );
        public const int S_ASP_USER_ACCESS_DENIED = unchecked( 0x40125 );
        public const int S_JMC_LIMITED_SUPPORT = unchecked( 0x40146 );
        public const int S_CANNOT_REMAP_IN_EXCEPTION = unchecked( 0x40150 );
        public const int S_CANNOT_REMAP_NOT_AT_SEQUENCE_POINT = unchecked( 0x40151 );
        public const int S_GETPARENT_NO_PARENT = unchecked( 0x40531 );
        public const int S_GETDERIVEDMOST_NO_DERIVED_MOST = unchecked( 0x40541 );
        public const int S_GETMEMORYBYTES_NO_MEMORY_BYTES = unchecked( 0x40551 );
        public const int S_GETMEMORYCONTEXT_NO_MEMORY_CONTEXT = unchecked( 0x40561 );
        public const int S_GETSIZE_NO_SIZE = unchecked( 0x40571 );
        public const int S_GETEXTENDEDINFO_NO_EXTENDEDINFO = unchecked( 0x40591 );
        public const int S_ASYNC_STOP = unchecked( 0x40B02 );
