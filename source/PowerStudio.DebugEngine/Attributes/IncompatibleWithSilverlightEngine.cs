...
{
    public sealed class IncompatibleWithSilverlightEngine : IncompatibleDebugEngineAttribute
    {
        #region Overrides of IncompatibleDebugEngineAttribute

        public override string Name
        {
            get { return "guidSilverlightEng"; }
        }

        public override Guid Guid
        {
            get { return EngineGuids.SilverlightEngine; }
        }
