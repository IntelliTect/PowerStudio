...
{
    public sealed class IncompatibleWithNativeOnlyEngine : IncompatibleDebugEngineAttribute
    {
        #region Overrides of IncompatibleDebugEngineAttribute

        public override string Name
        {
            get { return "guidNativeOnlyEng"; }
        }

        public override Guid Guid
        {
            get { return EngineGuids.NativeOnlyEngine; }
        }
